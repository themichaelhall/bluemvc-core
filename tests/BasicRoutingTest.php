...
class BasicRoutingTest extends TestCase
{
    ...
    public function typeHintActionParameterPagesDataProvider()
    {
        return [
            ...
            ['mixedTypes/foo/', '', ['HTTP/1.1 404 Not Found'], StatusCode::NOT_FOUND],
            ['mixedTypes/foo/bar', '', ['HTTP/1.1 404 Not Found'], StatusCode::NOT_FOUND],
            ['mixedTypes/foo/bar/', '', ['HTTP/1.1 404 Not Found'], StatusCode::NOT_FOUND],
            ['mixedTypes/foo/', '', ['HTTP/1.1 404 Not Found'], StatusCode::NOT_FOUND],
            ['mixedTypes/foo/123', '', ['HTTP/1.1 404 Not Found'], StatusCode::NOT_FOUND],
            ['mixedTypes/foo/123/', '', ['HTTP/1.1 404 Not Found'], StatusCode::NOT_FOUND],
            ['mixedTypes/123/', 'MixedTypesAction: Foo=[integer:123], Bar=[string:]', ['HTTP/1.1 200 OK'], StatusCode::OK],
            ['mixedTypes/123/bar', 'MixedTypesAction: Foo=[integer:123], Bar=[string:bar]', ['HTTP/1.1 200 OK'], StatusCode::OK],
            ['mixedTypes/123/bar/', '', ['HTTP/1.1 404 Not Found'], StatusCode::NOT_FOUND],
