...
class BasicRoutingTest extends TestCase
{
    ...
    public function typeHintActionParameterPagesDataProvider()
    {
        return [
            ...
            ['mixedTypes/42/foo/123/', '', ['HTTP/1.1 404 Not Found'], StatusCode::NOT_FOUND],
            ['mixedTypes/42/123/', 'MixedTypesAction: TypeFloat=[double:42], TypeInt=[integer:123], TypeString=[string:]', ['HTTP/1.1 200 OK'], StatusCode::OK],
            ['mixedTypes/42/123/bar', 'MixedTypesAction: TypeFloat=[double:42], TypeInt=[integer:123], TypeString=[string:bar]', ['HTTP/1.1 200 OK'], StatusCode::OK],
