...
class ControllerTest extends TestCase
{
    ...
    public function typeHintActionParametersDataProvider()
    {
        return [
            ...
            ['intTypes', ['12345678901234567890', '-12345678901234567890'], StatusCode::OK, 'IntTypesAction: Foo=[integer:' . PHP_INT_MAX . '], Bar=[integer:' . PHP_INT_MIN . '], Baz=[NULL:], FooBar=[integer:42]'],
            ['mixedTypes', [], StatusCode::NOT_FOUND, ''],
            ['mixedTypes', ['foo', 'bar'], StatusCode::NOT_FOUND, ''],
            ['mixedTypes', ['123', 'bar'], StatusCode::OK, 'MixedTypesAction: Foo=[integer:123], Bar=[string:bar]'],
            ['mixedTypes', ['foo', '456'], StatusCode::NOT_FOUND, ''],
