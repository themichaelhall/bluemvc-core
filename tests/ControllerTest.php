...
class ControllerTest extends TestCase
{
    ...
    public function processTypeHintActionParametersTestControllerDataProvider(): array
    {
        return [
            ...
            ['mixedTypes', ['param1'], StatusCode::OK, 'MixedTypesAction: Foo=[string:param1], Bar=[boolean:], FooBar=[double:2.5]'],
            ['mixedTypes', ['param1', 'true'], StatusCode::OK, 'MixedTypesAction: Foo=[string:param1], Bar=[string:true], FooBar=[double:2.5]'],
            ['mixedTypes', ['param1', 'true', 'foo'], StatusCode::OK, 'MixedTypesAction: Foo=[string:param1], Bar=[string:true], FooBar=[string:foo]'],
            ['mixedTypes', ['param1', 'true', 'foo', 'bar'], StatusCode::NOT_FOUND, ''],
            ['unionTypes', [], StatusCode::NOT_FOUND, ''],
            ['unionTypes', ['foo'], StatusCode::NOT_FOUND, ''],
            ['unionTypes', ['foo', 'bar'], StatusCode::NOT_FOUND, ''],
            ['unionTypes', ['foo', 'bar', 'baz'], StatusCode::NOT_FOUND, ''],
            ['unionTypes', ['10'], StatusCode::OK, 'UnionTypesAction: TypeBoolInt=[integer:10], TypeStringClassNull=[NULL:]'],
            ['unionTypes', ['10', 'bar'], StatusCode::OK, 'UnionTypesAction: TypeBoolInt=[integer:10], TypeStringClassNull=[string:bar]'],
            ['unionTypes', ['10', 'bar', 'baz'], StatusCode::NOT_FOUND, ''],
            ['unionTypes', ['true'], StatusCode::OK, 'UnionTypesAction: TypeBoolInt=[boolean:1], TypeStringClassNull=[NULL:]'],
            ['unionTypes', ['true', 'bar'], StatusCode::OK, 'UnionTypesAction: TypeBoolInt=[boolean:1], TypeStringClassNull=[string:bar]'],
            ['unionTypes', ['true', 'bar', 'baz'], StatusCode::NOT_FOUND, ''],
            ['blendedTypes', [], StatusCode::NOT_FOUND, ''],
            ['blendedTypes', ['1.0', 'foo', 'bar'], StatusCode::OK, 'BlendedTypesAction: TypeFloat=[double:1], TypeNon=[string:foo], TypeString=[string:bar], TypeBool=[boolean:]'],
            ['blendedTypes', ['1.0', '123', 'bar'], StatusCode::OK, 'BlendedTypesAction: TypeFloat=[double:1], TypeNon=[string:123], TypeString=[string:bar], TypeBool=[boolean:]'],
            ['blendedTypes', ['1.0', 'foo', '456'], StatusCode::OK, 'BlendedTypesAction: TypeFloat=[double:1], TypeNon=[string:foo], TypeString=[string:456], TypeBool=[boolean:]'],
            ['blendedTypes', ['baz', '123', 'bar'], StatusCode::NOT_FOUND, ''],
            ['blendedTypes', ['1.0', '123', 'bar', 'true'], StatusCode::OK, 'BlendedTypesAction: TypeFloat=[double:1], TypeNon=[string:123], TypeString=[string:bar], TypeBool=[boolean:1]'],
            ['blendedTypes', ['1.0', '123', 'bar', 'baz'], StatusCode::NOT_FOUND, ''],
