...
/**
 * Test RedirectResultException class.
 */
class RedirectResultExceptionTest extends TestCase
{
    /**
    ...
    public function testWithAbsoluteUrl()
    {
        ...
        $actionResultException = new RedirectResultException('https://domain.org/baz?query');
    ...
    public function testWithRelativeUrl()
    {
        ...
        $request = new BasicTestRequest(Url::parse('https://www.example.com/foo/bar'), new Method('GET'));
        $response = new BasicTestResponse();
        $actionResultException = new RedirectResultException('../baz');
        $actionResultException->getActionResult()->updateResponse($application, $request, $response);
    ...
    public function testWithEmptyUrl()
    {
        ...
        $response = new BasicTestResponse();
        $actionResultException = new RedirectResultException();
        $actionResultException->getActionResult()->updateResponse($application, $request, $response);
    ...
    public function testWithInvalidUrlParameter()
    {
        ...
        $request = new BasicTestRequest(Url::parse('https://www.example.com/foo/bar'), new Method('GET'));
        $response = new BasicTestResponse();
        $actionResultException = new RedirectResultException('foobar://localhost/');
        $actionResultException->getActionResult()->updateResponse($application, $request, $response);
    }
