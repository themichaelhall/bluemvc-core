...
class ApplicationRoutingTest extends TestCase
{
    ...
    public function typeHintActionParametersPagesRouteDataProvider(): array
    {
        return [
            ...
            ['mixedTypes/', 'MixedTypesAction: Foo=[string:], Bar=[boolean:], FooBar=[double:2.5]', ['HTTP/1.1 200 OK'], StatusCode::OK],
            ['mixedTypes/param1', 'MixedTypesAction: Foo=[string:param1], Bar=[boolean:], FooBar=[double:2.5]', ['HTTP/1.1 200 OK'], StatusCode::OK],
            ['mixedTypes/param1/', 'MixedTypesAction: Foo=[string:param1], Bar=[string:], FooBar=[double:2.5]', ['HTTP/1.1 200 OK'], StatusCode::OK],
            ['mixedTypes/param1/true', 'MixedTypesAction: Foo=[string:param1], Bar=[string:true], FooBar=[double:2.5]', ['HTTP/1.1 200 OK'], StatusCode::OK],
            ['mixedTypes/param1/true/', 'MixedTypesAction: Foo=[string:param1], Bar=[string:true], FooBar=[string:]', ['HTTP/1.1 200 OK'], StatusCode::OK],
            ['mixedTypes/param1/true/foo', 'MixedTypesAction: Foo=[string:param1], Bar=[string:true], FooBar=[string:foo]', ['HTTP/1.1 200 OK'], StatusCode::OK],
            ['mixedTypes/param1/true/foo/', '', ['HTTP/1.1 404 Not Found'], StatusCode::NOT_FOUND],
            ['mixedTypes/param1/true/foo/bar', '', ['HTTP/1.1 404 Not Found'], StatusCode::NOT_FOUND],
            ['unionTypes', '', ['HTTP/1.1 404 Not Found'], StatusCode::NOT_FOUND],
            ['unionTypes/foo', '', ['HTTP/1.1 404 Not Found'], StatusCode::NOT_FOUND],
            ['unionTypes/foo/', '', ['HTTP/1.1 404 Not Found'], StatusCode::NOT_FOUND],
            ['unionTypes/foo/bar', '', ['HTTP/1.1 404 Not Found'], StatusCode::NOT_FOUND],
            ['unionTypes/foo/bar/', '', ['HTTP/1.1 404 Not Found'], StatusCode::NOT_FOUND],
            ['unionTypes/foo/bar/baz', '', ['HTTP/1.1 404 Not Found'], StatusCode::NOT_FOUND],
            ['unionTypes/10', 'UnionTypesAction: TypeBoolInt=[integer:10], TypeStringClassNull=[NULL:]', ['HTTP/1.1 200 OK'], StatusCode::OK],
            ['unionTypes/10/', 'UnionTypesAction: TypeBoolInt=[integer:10], TypeStringClassNull=[string:]', ['HTTP/1.1 200 OK'], StatusCode::OK],
            ['unionTypes/10/bar', 'UnionTypesAction: TypeBoolInt=[integer:10], TypeStringClassNull=[string:bar]', ['HTTP/1.1 200 OK'], StatusCode::OK],
            ['unionTypes/10/bar/', '', ['HTTP/1.1 404 Not Found'], StatusCode::NOT_FOUND],
            ['unionTypes/10/bar/baz', '', ['HTTP/1.1 404 Not Found'], StatusCode::NOT_FOUND],
            ['unionTypes/true', 'UnionTypesAction: TypeBoolInt=[boolean:1], TypeStringClassNull=[NULL:]', ['HTTP/1.1 200 OK'], StatusCode::OK],
            ['unionTypes/true/', 'UnionTypesAction: TypeBoolInt=[boolean:1], TypeStringClassNull=[string:]', ['HTTP/1.1 200 OK'], StatusCode::OK],
            ['unionTypes/true/bar', 'UnionTypesAction: TypeBoolInt=[boolean:1], TypeStringClassNull=[string:bar]', ['HTTP/1.1 200 OK'], StatusCode::OK],
            ['unionTypes/true/bar/', '', ['HTTP/1.1 404 Not Found'], StatusCode::NOT_FOUND],
            ['unionTypes/true/bar/baz', '', ['HTTP/1.1 404 Not Found'], StatusCode::NOT_FOUND],
            ['blendedTypes', '', ['HTTP/1.1 404 Not Found'], StatusCode::NOT_FOUND],
            ['blendedTypes/42/foo/', 'BlendedTypesAction: TypeFloat=[double:42], TypeNon=[string:foo], TypeString=[string:], TypeBool=[boolean:]', ['HTTP/1.1 200 OK'], StatusCode::OK],
            ['blendedTypes/42/foo/bar', 'BlendedTypesAction: TypeFloat=[double:42], TypeNon=[string:foo], TypeString=[string:bar], TypeBool=[boolean:]', ['HTTP/1.1 200 OK'], StatusCode::OK],
            ['blendedTypes/42/foo/bar/', '', ['HTTP/1.1 404 Not Found'], StatusCode::NOT_FOUND],
            ['blendedTypes/42/foo/123', 'BlendedTypesAction: TypeFloat=[double:42], TypeNon=[string:foo], TypeString=[string:123], TypeBool=[boolean:]', ['HTTP/1.1 200 OK'], StatusCode::OK],
            ['blendedTypes/42/foo/123/', '', ['HTTP/1.1 404 Not Found'], StatusCode::NOT_FOUND],
            ['blendedTypes/42/123/', 'BlendedTypesAction: TypeFloat=[double:42], TypeNon=[string:123], TypeString=[string:], TypeBool=[boolean:]', ['HTTP/1.1 200 OK'], StatusCode::OK],
            ['blendedTypes/42/123/bar', 'BlendedTypesAction: TypeFloat=[double:42], TypeNon=[string:123], TypeString=[string:bar], TypeBool=[boolean:]', ['HTTP/1.1 200 OK'], StatusCode::OK],
            ['blendedTypes/42/123/bar/', '', ['HTTP/1.1 404 Not Found'], StatusCode::NOT_FOUND],
            ['blendedTypes/baz/123/bar', '', ['HTTP/1.1 404 Not Found'], StatusCode::NOT_FOUND],
            ['blendedTypes/baz/123/bar/', '', ['HTTP/1.1 404 Not Found'], StatusCode::NOT_FOUND],
            ['blendedTypes/42/123/bar/true', 'BlendedTypesAction: TypeFloat=[double:42], TypeNon=[string:123], TypeString=[string:bar], TypeBool=[boolean:1]', ['HTTP/1.1 200 OK'], StatusCode::OK],
            ['blendedTypes/42/123/bar/false', 'BlendedTypesAction: TypeFloat=[double:42], TypeNon=[string:123], TypeString=[string:bar], TypeBool=[boolean:]', ['HTTP/1.1 200 OK'], StatusCode::OK],
            ['blendedTypes/42/123/bar/baz', '', ['HTTP/1.1 404 Not Found'], StatusCode::NOT_FOUND],
            ['blendedTypes/42/123/bar/true/false', '', ['HTTP/1.1 404 Not Found'], StatusCode::NOT_FOUND],
